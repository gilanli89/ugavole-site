          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://facebook.com/ugavole" target="_blank" rel="noopener noreferrer"
                 className="w-9 h-9 bg-[#1877F2]/20 hover:bg-[#1877F2] text-[#1877F2] hover:text-white rounded-lg flex items-center justify-center transition-colors">
              ...
              <a href="https://instagram.com/ugavole.cyp" target="_blank" rel="noopener noreferrer"
                 className="w-9 h-9 bg-[#E1306C]/20 hover:bg-[#E1306C] text-[#E1306C] hover:text-white rounded-lg flex items-center justify-center transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://youtube.com/ugavole" target="_blank" rel="noopener noreferrer"
                 className="w-9 h-9 bg-[#FF0000]/20 hover:bg-[#FF0000] text-[#FF0000] hover:text-white rounded-lg flex items-center justify-center transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="https://x.com/ugavole" target="_blank" rel="noopener noreferrer"
                 className="w-9 h-9 bg-white/10 hover:bg-white text-white hover:text-black rounded-lg flex items-center justify-center transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
