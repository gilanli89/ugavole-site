    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="mb-10">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="https://facebook.com/ugavole"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-[#1877F2] text-white px-5 py-3 rounded-xl font-bold text-sm hover:opacity-90 transition-opacity"
          >
          ...
          <a
            href="https://instagram.com/ugavole.cyp"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white px-5 py-3 rounded-xl font-bold text-sm hover:opacity-90 transition-opacity"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            href="https://youtube.com/ugavole"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-[#FF0000] text-white px-5 py-3 rounded-xl font-bold text-sm hover:opacity-90 transition-opacity"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
